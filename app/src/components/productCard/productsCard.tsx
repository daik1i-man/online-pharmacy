...
export default function ProductsCard({ name, id, img_url, price, cart, favourites }: productCardDatasProps) {
    ...
    return (
        ...
        >
            ...
            <Link href={`/product/${id}`}>
                <h5 className="font-medium text-gray-900 product_name">
                    {name}
                </h5>
            </Link>
            <div className="absolute bottom-2">
                <div className="flex items-center bottom_items_row">
                    <span className="text-gray-900 product_price">{`${price} UZS`}</span>
                    {cart ? (
                        <button
                            onClick={() => onDelete(id)}
                            className="p-2 text-xs font-medium text-center text-red-500 bg-gray-200 rounded-full"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 delete_to_cart_icon">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 add_to_cart_icon">
