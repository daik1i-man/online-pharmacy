...
function NavigationMenu() {
    ...
    return (
        <div className="main">
            <div className="fixed bottom-1.5 left-0 right-0 m-1.5 backdrop-blur-md backdrop-contrast-75 flex items-center rounded-full justify-between mx-auto z-[80] w-[97%] navigation_bar py-2 px-5">
                ...
                <Link href='/favourites' className='flex flex-col items-center'>
                    <Badge content={favorites?.length} color="default">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-[18px]">
