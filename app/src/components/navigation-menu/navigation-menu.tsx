...
function NavigationMenu() {
    ...
    return (
        <div className="main">
            <div className="fixed bottom-1.5 left-0 right-0 m-1.5 backdrop-blur-md backdrop-contrast-75 flex items-center rounded-full justify-between mx-auto z-[10] w-[97%] navigation_bar py-2 px-5">
