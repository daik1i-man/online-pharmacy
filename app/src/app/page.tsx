  ...
  return (
    <div>
      <div className='justify-center w-full main'>
        ...
        <div className="fixed bottom-0 bg-gray-50 rounded-md flex items-center justify-between mx-auto z-[80] p-2.5 w-full h-17 navigation_bar px-4">
          <Link href='/categories' className='flex flex-col items-center'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mx-auto size-7">
        ...
        <div className='my-12 mx-auto justify-center w-full px-4 -mr-2'>
