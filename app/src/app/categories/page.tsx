...
export default function Categories() {
    ...
    return (
        <>
            <div className="mx-auto w-[600px] relative main">
                <div className='w-6 h-6 px-0.5 py-1 absolute bg-gray-100 rounded-full cursor-pointer z-20 -mt-10 mx-4' onClick={backHandler}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                    </svg>
                </div>
                <div className="grid grid-cols-3 gap-3 px-4 mt-24 mb-12">
